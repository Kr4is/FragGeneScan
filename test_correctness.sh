...
./run_FragGeneScan.pl -genome=./example/NC_000913.fna -out=./tests/NC_000913-fgs  -complete=1  -train=complete -processes=$1
echo ""

echo "---> Sequencing reads"
./run_FragGeneScan.pl -genome=./example/NC_000913-454.fna -out=./tests/NC_000913-454-fgs  -complete=0  -train=454_10 -processes=$1
echo ""

echo "---> Assembly contigs"
./run_FragGeneScan.pl -genome=./example/contigs.fna -out=./tests/contigs-fgs  -complete=1  -train=complete -processes=$1
echo ==================================================
echo ""
